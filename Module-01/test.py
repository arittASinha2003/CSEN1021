...
if choice == '1':
    ...
    print("Select side: ")
    print("1. Person1 hates Person2")
    print("2. Person2 hates Person1")
    print("3. Both Person1 and Person2 hates each other")
    choice = input("Enter choice (1/2/3): ")
    if choice == '1':
        print(Person1,"hates",Person2)
    elif choice == '2':
        print(Person2,"hates",Person1)
    elif choice == '3':
        print("Both",Person1,"and",Person2,"hates each other")
    else:
        print("Invalid input")
else:
    print("Invalid input")